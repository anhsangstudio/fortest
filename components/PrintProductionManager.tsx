...
const PrintProductionManager: React.FC<Props> = ({ currentUser }) => {
  ...
  return <div className="space-y-6 p-6">
    ...
    {editingRow && headerForm && <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/40 p-2 sm:p-4"><div className="w-full max-w-[96vw] 2xl:max-w-7xl max-h-[calc(100vh-16px)] sm:max-h-[calc(100vh-32px)] overflow-y-auto overflow-x-hidden rounded-[24px] sm:rounded-[30px] bg-slate-50 shadow-2xl">
